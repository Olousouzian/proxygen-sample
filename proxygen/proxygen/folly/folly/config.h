...
#define HAVE_BITS_C__CONFIG_H 1

/* Define to 1 if you have the <bits/functexcept.h> header file. */
#define HAVE_BITS_FUNCTEXCEPT_H 1
...
#define HAVE_CPLUS_DEMANGLE_V3_CALLBACK 1
...
/* Define to 1 if you have the `double-conversion' library
   (-ldouble-conversion). */
#define HAVE_LIBDOUBLE_CONVERSION 1
...
#define PACKAGE_STRING "folly 57.0"
...
#define UNUSUAL_GFLAGS_NAMESPACE 1
